...
import bank_exception.InsufficientFundsException;
...
public class ICICIBank implements Bank {
    ...
    private static HashMap<Integer, Account> hashMap = new HashMap<>();

    private static HashMap<Integer, List<String>> trasaction = new HashMap<>();
    ...
    public void setHashMap(HashMap<Integer, Account> hashMap) {
        ICICIBank.hashMap = hashMap;
    }

    public HashMap<Integer, List<String>> getTransaction() {
        return trasaction;
    }

    public void setTransaction(HashMap<Integer, List<String>> trasaction) {
        ICICIBank.trasaction = trasaction;
    }
    ...
    public void joint() {
        ...
        if (sc.nextInt()==1){
            account = bankUtil.createBank("ICICI");
        }
        else {
    ...
    public void createAccount() {
        ...
        Account account = bankUtil.createBank("ICICI");
...
//        second account
        HashMap<Integer, List<String>> trasaction2 = bank.getTransaction();
