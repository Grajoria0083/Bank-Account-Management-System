...
//        second account
        HashMap<Integer, List<String>> transaction2 = bank.getTransaction();
        List<String> list2 = transaction2.get(ac2);
        if (list2==null){
            List<String> list1 = new ArrayList<>();
            list1.add("Trasfer : "+amount+ " on "+LocalDateTime.now());
            transaction2.put(ac2, list1);
        }
        else {
            list2.add("Transfer: "+amount+ " on "+LocalDateTime.now());
            transaction2.put(ac2, list2);
        }
    }
